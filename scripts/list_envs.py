...
All the environments are registered in the `M20_Piper` extension. They start
...
import M20_Piper.tasks  # noqa: F401


def main():
    """Print all environments registered in `M20_Piper` extension."""
